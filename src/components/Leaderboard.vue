...
<script setup>
    const leaderboard =  [
          { id: 1, name: 'Justin', score1: 87.5, score2: 600, score3: 51, score4: 55, score5: 105, score6: 0, get total() { return this.score1 + this.score2 + this.score3 + this.score4 + this.score5 + this.score6} },
