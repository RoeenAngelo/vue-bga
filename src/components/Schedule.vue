...
const schedule = [
    ...
    {
        name: 'BGA Masters',
        location: 'Golf Course: Oak Quarry',
        date: 'April 16',
        time: '1:00 PM'
    },
    {
        name: 'PEJA OPEN',
        location: 'Golf Course: Los Serranos Country Club (South Course)',
        date: 'May 28',
        time: '1:00 PM'
    },
    {
            ...
            <div class="event">
                <div class="event-left">
                    <div class="event-date">
                        <div class="month">{{ event.date }}</div>
                    </div>
                </div>
...
.event .event-right .event-time img {
	height: 20px;
	padding-right: 8px ;
}
